...
(async () => {
  ...
  for (const [t, date] of SHIFTS) {
    ...
    if (!avInserted.has(key)) {
      await p.availability.create({
        data: { secretaryId: id(t), date, status: "disponibile", start: null, end: null, note: null },
      });
      avInserted.add(key);
    }
  }
  ...
  const AVAIL_EXTRA = [
    ...
    ["mara-7f3a",  "2026-05-01", "disponibile",     null,    null,    null],
    ["mara-7f3a",  "2026-05-05", "non_disponibile", null,    null,    null],
    ["mara-7f3a",  "2026-05-09", "disponibile",     null,    null,    null],
    ["mara-7f3a",  "2026-05-12", "disponibile",     null,    null,    null],
    ["mara-7f3a",  "2026-05-13", "parziale",        "08:00", "13:00", "esco a mezzogiorno"],
    ["mara-7f3a",  "2026-05-18", "non_disponibile", null,    null,    "impegno personale"],
    ["mara-7f3a",  "2026-05-21", "disponibile",     null,    null,    null],
    ["mara-7f3a",  "2026-05-25", "disponibile",     null,    null,    null],
    ["mara-7f3a",  "2026-05-29", "non_disponibile", null,    null,    null],
    ["mara-7f3a",  "2026-05-31", "non_disponibile", null,    null,    null],

    // Sonia — libera: 1,3,6,8,11,15,16,17,19,20,24,26,27,29,30
    ["sonia-2b9c", "2026-05-01", "disponibile",     null,    null,    null],
    ["sonia-2b9c", "2026-05-03", "non_disponibile", null,    null,    null],
    ["sonia-2b9c", "2026-05-06", "disponibile",     null,    null,    null],
    ["sonia-2b9c", "2026-05-08", "disponibile",     null,    null,    null],
    ["sonia-2b9c", "2026-05-11", "disponibile",     null,    null,    null],
    ["sonia-2b9c", "2026-05-15", "parziale",        "08:00", "14:00", "solo mattina"],
    ["sonia-2b9c", "2026-05-17", "non_disponibile", null,    null,    null],
    ["sonia-2b9c", "2026-05-24", "non_disponibile", null,    null,    "ferie"],
    ["sonia-2b9c", "2026-05-26", "disponibile",     null,    null,    null],
    ["sonia-2b9c", "2026-05-30", "non_disponibile", null,    null,    null],

    // Beatrice — libera: 2,6,8,9,11,13,14,17,20,22,23,24,30
    ["bea-5e1d",   "2026-05-02", "non_disponibile", null,    null,    null],
    ["bea-5e1d",   "2026-05-06", "disponibile",     null,    null,    null],
    ["bea-5e1d",   "2026-05-08", "disponibile",     null,    null,    null],
    ["bea-5e1d",   "2026-05-09", "non_disponibile", null,    null,    null],
    ["bea-5e1d",   "2026-05-11", "disponibile",     null,    null,    null],
    ["bea-5e1d",   "2026-05-13", "disponibile",     null,    null,    null],
    ["bea-5e1d",   "2026-05-14", "disponibile",     null,    null,    null],
    ["bea-5e1d",   "2026-05-17", "non_disponibile", null,    null,    null],
    ["bea-5e1d",   "2026-05-20", "parziale",        "08:00", "14:00", "mattina ok"],
    ["bea-5e1d",   "2026-05-22", "non_disponibile", null,    null,    null],
    ["bea-5e1d",   "2026-05-23", "disponibile",     null,    null,    null],
    ["bea-5e1d",   "2026-05-30", "non_disponibile", null,    null,    null],

    // Emma — libera: 2,3,4,7,8,10,13,14,15,16,18,21,23,26,27,31
    ["emma-9a4f",  "2026-05-02", "non_disponibile", null,    null,    null],
    ["emma-9a4f",  "2026-05-04", "parziale",        "14:00", "19:00", "solo pomeriggio"],
    ["emma-9a4f",  "2026-05-07", "disponibile",     null,    null,    null],
    ["emma-9a4f",  "2026-05-08", "non_disponibile", null,    null,    null],
    ["emma-9a4f",  "2026-05-10", "disponibile",     null,    null,    null],
    ["emma-9a4f",  "2026-05-13", "disponibile",     null,    null,    null],
    ["emma-9a4f",  "2026-05-15", "disponibile",     null,    null,    null],
    ["emma-9a4f",  "2026-05-16", "non_disponibile", null,    null,    null],
    ["emma-9a4f",  "2026-05-18", "disponibile",     null,    null,    null],
    ["emma-9a4f",  "2026-05-21", "disponibile",     null,    null,    null],
    ["emma-9a4f",  "2026-05-23", "non_disponibile", null,    null,    "impegno"],
    ["emma-9a4f",  "2026-05-26", "disponibile",     null,    null,    null],
    ["emma-9a4f",  "2026-05-31", "non_disponibile", null,    null,    null],

    // Arianna — libera: 2,4,5,7,9,10,12,16,20,21,22,23,25,28,29,31
    ["ari-c8d2",   "2026-05-02", "non_disponibile", null,    null,    null],
    ["ari-c8d2",   "2026-05-04", "non_disponibile", null,    null,    null],
    ["ari-c8d2",   "2026-05-05", "disponibile",     null,    null,    null],
    ["ari-c8d2",   "2026-05-07", "disponibile",     null,    null,    null],
    ["ari-c8d2",   "2026-05-09", "parziale",        "09:00", "15:00", "disponibile fino alle 15"],
    ["ari-c8d2",   "2026-05-10", "disponibile",     null,    null,    null],
    ["ari-c8d2",   "2026-05-12", "non_disponibile", null,    null,    null],
    ["ari-c8d2",   "2026-05-16", "disponibile",     null,    null,    null],
    ["ari-c8d2",   "2026-05-20", "disponibile",     null,    null,    null],
    ["ari-c8d2",   "2026-05-22", "non_disponibile", null,    null,    null],
    ["ari-c8d2",   "2026-05-25", "non_disponibile", null,    null,    null],
    ["ari-c8d2",   "2026-05-28", "disponibile",     null,    null,    null],
    ["ari-c8d2",   "2026-05-29", "disponibile",     null,    null,    null],
    ["ari-c8d2",   "2026-05-31", "non_disponibile", null,    null,    null],
  ];

  for (const [t, date, status, start, end, note] of AVAIL_EXTRA) {
    const key = `${t}|${date}`;
    if (avInserted.has(key)) {
    ...
    await p.availability.create({
      data: { secretaryId: id(t), date, status, start: start ?? null, end: end ?? null, note: note ?? null },
    });
    avInserted.add(key);
  }
