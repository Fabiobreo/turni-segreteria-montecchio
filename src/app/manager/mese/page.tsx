...
import { MonthContentSkeleton } from "@/components/skeletons";
  ...
  return (
    <>
      ...
      <Container maxWidth="lg" sx={{ py: 2.5 }}>
        ...
        <Suspense fallback={<MonthContentSkeleton />}>
          <MonthContent monthKey={monthKey} />
        </Suspense>
      </Container>
    </>
  );
...
/** Calendario mensile + sidebar stato. */
async function MonthContent({ monthKey }: { monthKey: string }) {
